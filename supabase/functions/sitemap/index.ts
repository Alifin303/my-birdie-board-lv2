...
const routes: { path: string; priority: string; changefreq: string }[] = [
  ...
  { path: '/blog/golf-score-tracking-tips', priority: '0.7', changefreq: 'monthly' },
  ...
  { path: '/blog/understanding-golf-handicap-system', priority: '0.7', changefreq: 'monthly' },
  ...
  { path: '/blog/putts-per-round', priority: '0.7', changefreq: 'monthly' },
