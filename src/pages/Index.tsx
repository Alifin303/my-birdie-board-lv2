...
const Index = () => {
  ...
  useEffect(() => {
    const calculateHeight = () => {
      if (reviewSectionRef.current && mainContentRef.current) {
        const reviewsTop = reviewSectionRef.current.offsetTop;
        setBackgroundHeight(reviewsTop);
      }
    };
  ...
  return (
    <>
      ...
      <div 
        ...
        style={{
          backgroundImage: `url('/lovable-uploads/2c23947e-10e1-4f3f-92dd-deb9bf4cbf46.png')`,
