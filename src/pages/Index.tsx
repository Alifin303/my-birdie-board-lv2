  ...
  return (
    <div className="min-h-screen flex flex-col">
      <div 
        ...
        style={{
          backgroundImage: `linear-gradient(to bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.4)), url('https://images.unsplash.com/photo-1587174337441-31baf62f4daa?auto=format&fit=crop&q=80')`,
        }}
      >
