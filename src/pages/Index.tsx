...
const Index = () => {
  ...
  return <>
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <div className="fixed top-0 left-0 right-0 bottom-0 z-[1]" style={{
        backgroundImage: `url('/lovable-uploads/6d2e3fbf-b1fd-4a8c-b987-2c30c6371a2d.png')`,
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        backgroundRepeat: 'no-repeat',
        height: 'calc(100vh - 300px)',
        // Adjust to end before UserReviews
        pointerEvents: 'none' // Allow clicks to pass through to elements below
      }} />
        
        <div className="relative flex-1 z-[2]" style={{
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-5xl mx-auto mb-12 animate-fade-in">
                ...
                <div className="flex justify-center mt-6 mb-12">
                  <Button size="lg" onClick={handleStartSignup} aria-label="Sign up for MyBirdieBoard" className="text-lg px-8 h-12 shadow-lg transition-all duration-300 bg-[#bac9b5] text-primary-DEFAULT">
