...
export const ScorecardHeader = ({
  ...
  // Log the incoming tee name for debugging
  console.log(`ScorecardHeader - Raw tee_name from round:`, round.tee_name);
  console.log(`ScorecardHeader - Raw tee_id from round:`, round.tee_id);
