  ...
  return <div className="w-full mx-auto flex flex-col justify-between min-h-screen">
      <section aria-labelledby="hero-heading" className="flex-grow flex flex-col justify-center items-center px-4 py-6 text-center mt-4 sm:mt-0">
        <div className="max-w-5xl animate-fade-in mb-4 px-0 mx-0">
          ...
          <p className="text-sm sm:text-base md:text-lg text-white/90 font-medium mb-8 max-w-3xl mx-auto bg-black/35 backdrop-blur-sm px-4 py-2 rounded-lg lg:text-lg">Capture your full golf story, round by round, stat by stat, all after you play. Use any scorecard or app on the course, then log it all at MyBirdieBoard.com.</p>
