...
export function SignUpDialog({
  ...
  return <Dialog open={open !== undefined ? open : isOpen} onOpenChange={handleOpenChange}>
      <DialogTrigger asChild>
        <Button size="lg" className="text-accent-foreground text-lg px-8 h-12 shadow-lg transition-all duration-300 bg-secondary-foreground">
      ...
      <DialogContent className="sm:max-w-[425px] bg-card">
        ...
        {signupSuccess ? <div className="flex flex-col items-center justify-center py-6 space-y-4">
